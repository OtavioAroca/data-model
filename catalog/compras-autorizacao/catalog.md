...
| Integration | `integration_purchase_journey` | Une purchase de crédito e débito (schema padronizado) com o detalhamento de parcelas do crédito — grão de compra, com parcelas relacionadas quando existirem | Risco, fraude, atendimento, Time de Performance | Time de Autorização | V0 — a validar |
