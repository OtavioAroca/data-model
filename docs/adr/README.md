...
| [0010](./0010-mapa-interativo-embutido-no-estudo-de-caso.md) | Mapa interativo embutido no Estudo de Caso; template do mapa reconciliado com o arquivo gerado | Proposto |
