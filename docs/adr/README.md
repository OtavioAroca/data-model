...
| [0009](./0009-grid-subdominios-por-camada-produto-pagina-unica-sem-emoji.md) | Grid de subdomínios por camada de produto (Core/Integration/Analytics), página única, sem emojis | Aceito |
